        ...
        <div className="flex h-screen overflow-hidden bg-light-50 dark:bg-[#0A0A0A]">
            ...
            <main className="flex-1 flex justify-center pr-60 ">
                <div className="max-w-2xl mx-auto w-full bg-[#0A0A0A]  min-h-screen relative">
                    {header}
                    <div className="absolute top-18 w-full h-6 bg-[#101010] rounded-t-full border-t border-l border-r border-[#383939] z-41"></div>
                    <div className="mt-1 border-l border-r border-t-0 border-[#383939] rounded-t-4xl pb-3 bg-[#101010]">
