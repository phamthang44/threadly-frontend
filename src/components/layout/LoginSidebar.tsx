...
export const LoginSidebar: React.FC = () => {
    return (
        <aside className="hidden lg:block lg:fixed 2xl:right-98 xl:right-30 max-[1300px]:right-10 top-14 w-80 h-80 mt-4 rounded-4xl bg-[#1E1E1E] border-1 border-[#383939] p-4">
