...
export const LoginSidebar: React.FC = () => {
    return (
        <aside className="hidden lg:block fixed right-120 top-14 w-80 h-80 mt-4 rounded-4xl bg-[#1E1E1E] border-1 border-[#383939] p-4">
            <div className="flex flex-col items-center justify-center h-full">
                <h2 className="text-white text-xl font-bold mb-2 text-center">Log in or sign up for Threads</h2>
