...
export const LoginSidebar: React.FC<LoginSidebarProps> = ({ isAuthenticated }) => {
    ...
    return (
        <aside className="hidden lg:block lg:fixed 2xl:right-70 xl:right-30 max-[1300px]:right-10 top-17 w-80 h-80 mt-4 rounded-4xl bg-[#1E1E1E] border-1 border-[#383939] p-4">
