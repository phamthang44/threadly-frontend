...
const LikeIcon:React.FC<IconProps> = ({className}) => {
    return (
        <svg aria-label="Like" role="img" viewBox="0 0 18 18"
                style={{
                    '--x-fill': 'transparent',
                    '--x-height': '19px',
                    '--x-width': '18.75px',
             ...
             w-[var(--x-width)] h-[var(--x-height)] stroke-2 fill-none stroke-current flex-shrink-0 relative block text-[var(--barcelona-charcoal-icon)]
             [stroke-linejoin:round] [forced-color-adjust:auto]
             `}
            ><title>Like</title>
            <path
