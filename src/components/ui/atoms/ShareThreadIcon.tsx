...
const ShareThreadIcon = (props: SVGProps<SVGElement>) => {
    return (
        <svg aria-label="" role="img" viewBox="2 2 16 16"
            ...
            <path
                ...
                stroke="currentColor" strokeLinecap="round" strokeWidth="1.65"></path>
            <path
                ...
                stroke="currentColor" strokeLinecap="round" strokeWidth="1.65"></path>
            <path d="M12.7051 7.29565L7.2942 12.7065" stroke="currentColor" strokeLinecap="round"
                  strokeWidth="1.65"></path>
        </svg>
    );
}

export default ShareThreadIcon;