...
const RestrictIcon = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg aria-label="" role="img" viewBox="0 0 20 20"
             className={props.className ? props.className : ''}><title></title>
            <path
                ...
                fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10"
                strokeWidth="1.5"></path>
            <circle cx="10" cy="4.5" fill="none" r="3.75" stroke="currentColor" strokeWidth="1.5"></circle>
            <path
